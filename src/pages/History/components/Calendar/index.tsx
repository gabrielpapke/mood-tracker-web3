...
function Calendar() {
    ...
    const { month, setMonth, setToday, setPastWeek, setPastThirtyDays } =
        useDateHistory()
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-between gap-2">
                <Button className="text-xs" onClick={setToday}>
                    Today
                </Button>
                <Button className="text-xs" onClick={setPastWeek}>
                    Past 7 days
                </Button>
                <Button className="text-xs" onClick={setPastThirtyDays}>
                    Past 30 days
                </Button>
            </div>
        </div>
